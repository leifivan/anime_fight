...
*
*/
function tripleTriad(enemy_id) {
    $dataTripleTriad.enemy_id = enemy_id;
    $dataTripleTriad.push_triple_triad = true;
    SceneManager.push(Scene_Album_TT);
};

function tripleTriadAddCard(card_id) {
    $dataTripleTriad.all_cards.push(card_id);
};

function tripleTriadRemoveCard(card_id) {
    if ($dataTripleTriad.self_tt_cards.includes(card_id))
        remove_specific_card_tt($dataTripleTriad.self_tt_cards, card_id);
    else
        remove_specific_card_tt($dataTripleTriad.all_cards, card_id);
};
...
function Game_TripleTriad() {
    //self_tt_cards: [0, 1, 4, 4, 4],
    //enemy_tt_cards: [1, 1, 4, 4, 4],
    this.self_tt_cards = [];
...
Scene_TripleTriad.prototype.load_plugin_parameters = function () {
    this.card_list = JSON.parse(PluginManager.parameters('TripleTriadCore')['Card Creation']);
    this.card_positions = JSON.parse(PluginManager.parameters('TripleTriadCore')['Card Positions']);
    this.aux_images = JSON.parse(PluginManager.parameters('TripleTriadCore')['Image Configuration']);
    var board_map = JSON.parse(PluginManager.parameters('TripleTriadCore')['Board Map']);
    this.board_score_images = JSON.parse(PluginManager.parameters('TripleTriadCore')['Board Score']);
    this.enemy_configuration = JSON.parse(PluginManager.parameters('TripleTriadCore')['Enemy Creation']);
...
Window_TripleTriad_Rules.prototype.write_rules = function () {
    this.enemy_configuration = JSON.parse(PluginManager.parameters('TripleTriadCore')['Enemy Creation']);
    this.card_list = JSON.parse(PluginManager.parameters('TripleTriadCore')['Rules']);
...
Scene_After_Match_TT.prototype.load_plugin_parameters = function () {
    this.image_list = JSON.parse(PluginManager.parameters('TripleTriadCore')['After Match']);
    this.card_list = JSON.parse(PluginManager.parameters('TripleTriadCore')['Card Creation']);
    this.aux_images = JSON.parse(PluginManager.parameters('TripleTriadCore')['Image Configuration']);
}
//-----------------------------------------------------------------------------
...
Scene_Album_TT.prototype.load_plugin_parameters = function () {
    this.image_list = JSON.parse(PluginManager.parameters('TripleTriadCore')['Album']);
    this.card_list = JSON.parse(PluginManager.parameters('TripleTriadCore')['Card Creation']);
    this.aux_images = JSON.parse(PluginManager.parameters('TripleTriadCore')['Image Configuration']);
};
...
Scene_Album_TT.prototype.initialize_cardList_windows = function () {
    ...
    this._cardListWindow = new Window_TripleTriad_CardList(150, 300, 300, Graphics.height - 300);
...
Scene_Album_TT.prototype.initialize_help_windows = function () {
    this._help = new Window_Base(0, 0, Graphics.width, 80);
...
Scene_Album_TT.prototype.initialize_hand_windows = function () {
    this._handWindow = new Window_Base(0, 80, Graphics.widtFh, 220);
...
Scene_Album_TT.prototype.initialize_cardDetails_windows = function () {
    this._cardDetailsWindow = new Window_TripleTriad_CardDetails(450, 300, Graphics.width - 600, Graphics.height - 300);
...
Scene_Album_TT.prototype.addCard = function () {
    ...
    this.card_end_position[0] = 300 + $dataTripleTriad.self_tt_cards.length * parseInt(this.image_list['Distance']);
...
Scene_Album_TT.prototype.open_not_enough_cards_window = function () {
    this._cardListWindow.deactivate();
    this.low_cards = new Window_Base(0, 200, Graphics.width, 80);
...
Window_TripleTriad_CardDetails.prototype.load_plugin_parameters = function () {
    this.card_list = JSON.parse(PluginManager.parameters('TripleTriadCore')['Card Creation']);
    this.aux_images = JSON.parse(PluginManager.parameters('TripleTriadCore')['Image Configuration']);
    this.album_text = JSON.parse(PluginManager.parameters('TripleTriadCore')['Album']);
